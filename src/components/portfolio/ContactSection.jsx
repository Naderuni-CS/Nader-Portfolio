          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div className="p-6 border border-white/10 rounded-xl bg-white/5 backdrop-blur-sm">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-red-500/20 flex items-center justify-center">
                    {siteConfig.socials.find(s => s.label === 'Email') ? React.createElement(siteConfig.socials.find(s => s.label === 'Email').icon, { className: "text-red-500", size: 20 }) : null}
                  </div>
                  <div>
                    <h4 className="text-white font-medium">Email</h4>
                    <p className="text-gray-500">{siteConfig.socials.find(s => s.label === 'Email')?.href?.replace('mailto:', '') || 'Reach out'}</p>
                  </div>
                </div>
              </div>
              </div>
