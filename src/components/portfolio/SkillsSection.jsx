...
const buckets = [
  {
    ...
    icon: Shield,
    items: ["Web App Pentesting", "Professional OSINT", "Compromised Account Recovery", "Privilege Escalation", "Reporting & Risk Rating"],
  },
  {
    title: "Tooling",
    icon: Terminal,
  ...
  },
  {
    title: "Code",
    icon: Code2,
    items: ["C++", "Python", "Bash", "Java", "C", "Automation scripts"],
  },
];
