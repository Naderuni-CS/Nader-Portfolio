    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          >
            <div className="w-10 h-10 border border-green-500/30 rounded-xl flex items-center justify-center overflow-hidden shadow-[0_0_20px_rgba(34,197,94,0.1)] group-hover:border-green-500/60 group-hover:shadow-[0_0_30px_rgba(34,197,94,0.3)] transition-all">
              <img src="/profilepic.jpg" alt="N" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = siteConfig.avatarUrl }} />
            </div>
          </motion.div>
        ...
        <div className="px-5 py-4 flex items-center justify-between backdrop-blur-xl bg-black/30 border-b border-white/5">
          <div className="flex items-center gap-4">
            <button onClick={() => scrollTo("home")} className="flex items-center gap-3">
              <div className="w-9 h-9 border border-green-500/30 rounded-xl flex items-center justify-center overflow-hidden shadow-[0_0_15px_rgba(34,197,94,0.1)]">
                <img src="/profilepic.jpg" alt="N" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = siteConfig.avatarUrl }} />
              </div>
